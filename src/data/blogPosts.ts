...
export const blogPosts: Record<string, BlogPost> = {
  "designing-for-trust-in-ai": {
    ...
    date: "March 15, 2025",
    content: `
      Trust is the foundation of any successful product, but it becomes especially crucial when artificial intelligence is involved. As we continue to integrate AI into more aspects of our daily lives, the need for thoughtful design that promotes transparency and user confidence has never been more important.
      ...
      The future of AI-powered products depends not just on technical capabilities, but on our ability to create interfaces that users can understand, trust, and confidently use to achieve their goals.
    `,
    slug: "designing-for-trust-in-ai"
  },
  "evolution-of-hospitality-design": {
    title: "The Evolution of Hospitality Design",
    date: "February 28, 2025",
    content: `
      The hospitality industry is undergoing a profound transformation, driven by changing guest expectations and technological advances. As someone deeply involved in both traditional hospitality and digital products, I've observed how these changes are reshaping the way we think about hospitality spaces.
      ...
      The most successful spaces will be those that find the sweet spot between innovation and tradition, technology and human touch, luxury and sustainability.
    `,
    slug: "evolution-of-hospitality-design"
  },
  "sustainable-digital-products": {
    title: "Building Sustainable Digital Products",
    date: "February 10, 2025",
    content: `
      As the digital world continues to grow, so does its environmental impact. The concept of sustainability in digital product design goes beyond energy efficiency—it encompasses the entire lifecycle of digital products and their long-term impact on users and society.
      ...
      As we continue to build and evolve digital products, let's ensure we're creating solutions that not only serve immediate needs but also contribute to a more sustainable digital future.
    `,
  ...
  "ai-in-customer-experience": {
    ...
    content: `
      Artificial Intelligence is revolutionizing how businesses understand and respond to customer needs. Through our work at Gleamly.ai, we've seen firsthand how AI can transform customer experience while maintaining the human touch that makes interactions meaningful.
      ...
      Looking ahead, we see AI becoming even more integral to customer experience, but always in service of human connections rather than replacing them. The goal is to create more meaningful, efficient, and personalized interactions that benefit both customers and businesses.
    `,
    slug: "ai-in-customer-experience"
  },
  "designing-for-slow-living": {
    title: "Designing for Slow Living",
    date: "January 15, 2025",
    content: `
      In our fast-paced digital world, there's growing interest in spaces and experiences that encourage mindfulness and presence. This shift towards "slow living" has profound implications for both digital and physical design.
      ...
      The future of design—whether digital or physical—lies in finding ways to support both productivity and presence, helping users find their own balance in an increasingly fast-paced world.
    `,
    slug: "designing-for-slow-living"
  }
};